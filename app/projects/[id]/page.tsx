      ...
      <div className="container-width pt-32 pb-20 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              {project.repoLink && project.repoLink !== "#" && (
                <Button variant="outline" onClick={() => window.open(project.repoLink, "_blank")}>
          ...
          <motion.div
            ...
            className="bg-secondary/10 border border-white/5 rounded-3xl p-8 backdrop-blur-sm h-fit"
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {project.role && (
                <div>
                  <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-2 flex items-center gap-2">
                    <Users size={14} /> Role
                  </h3>
        ...
        <motion.div
          ...
          className="relative w-full rounded-3xl overflow-hidden mb-20 border border-white/10 shadow-2xl bg-[#111]"
        >
           <div className="h-10 bg-[#1a1a1a] border-b border-white/5 flex items-center px-4 gap-2">
              ...
              <div className="flex-1 text-center text-xs text-muted-foreground font-mono bg-black/20 rounded py-1 mx-4 truncate opacity-50">
                 {project.demoLink}
              </div>
           </div>
          ...
          <div className="relative w-full h-[600px] bg-black">
             ...
             >
                <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center p-6">
                   ...
                   <p className="text-white/80 font-medium">Loading Interactive Preview...</p>
                </div>
             </div>
        ...
        {(project.features || project.challenge) && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            {project.features && (
              ...
              >
                <h3 className="font-heading text-2xl font-bold mb-6 text-primary">Key Features</h3>
            ...
            >
              {project.challenge && (
                <div>
                  <h3 className="font-heading text-3xl font-bold mb-4">The Challenge</h3>
              ...
              {project.solution && (
                <div>
                  <h3 className="font-heading text-3xl font-bold mb-4">The Solution</h3>
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    {project.solution}
                  </p>
                </div>
